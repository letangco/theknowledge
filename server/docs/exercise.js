/**
 * @api {post} /api/exercise/create-exercise Create Exercise
 * @apiName createExercise
 * @apiVersion 1.1.0
 * @apiGroup Exercise
 *
 * @apiParam {String} title Exerise's title
 * @apiParam {String} description Exerise's description. Exception: 2-ExerciseVOA - Paragraph answer of exercise
 * @apiParam {user} user Exerise's creator
 * @apiParam {Number} type Exercise's type. Data list: 1: ExerciseBBC, 2: ExerciseVOA, 3: ExerciseReadingKeyword, 4: ExerciseMatching, 5: ExerciseWriting, 6: ExerciseWritingIELTS
 * @apiParam {Number} url Exercise's url audio. Require for: 1: ExerciseBBC, 2: ExerciseVOA
